...
{
    public class CallbackStorage : AzureTableStorageAbstract
    {
        public CallbackStorage(string connectionString)
            : base(connectionString, "Callbacks") { }
